...
Feature: BisonTransport Page
  ...
  Scenario: TC01_User goes to BisonTransport Page
    ...
    Given User clicks Services link on the home page
      ...
      Then User selects Full Truckload under "1. SELECT FREIGHT TYPE"
      Then User selects Live load under "1. SELECT FREIGHT TYPE"
      Then User selects Live Unload under "1. SELECT FREIGHT TYPE"
      ...
      And User enters Pennsylvania under the Pick Up City
