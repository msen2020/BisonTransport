...
public class HomePageSteps extends CommonPage {
    ...
    public void userVerifiesTheLinksAreVisibleAndFunctional(DataTable dataTable) {
        ...
        for (String expectedLink : expectedLinks) {
            try {
                ...
                String urlBeforeClick = DriverManager.getInstance().getCurrentDriver().getCurrentUrl();
                String titleBeforeClick = DriverManager.getInstance().getCurrentDriver().getTitle();
                ...
                String urlAfterClick = DriverManager.getInstance().getCurrentDriver().getCurrentUrl();
                String titleAfterClick = DriverManager.getInstance().getCurrentDriver().getTitle();
